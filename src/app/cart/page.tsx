...
export default function CartPage() {
  ...
  return (
    <div className="py-20 px-6 max-w-4xl mx-auto">
      <h2 className="text-5xl font-extrabold mb-4 text-center text-emerald-800 tracking-tight">Giỏ Hàng Của Bạn</h2>
        ...
        <div className="space-y-6">
          {cart.map((item) => (
            <div key={item.id} className="flex justify-between items-center border-2 border-emerald-100 p-6 rounded-2xl bg-white shadow-sm">
              ...
              <p className="font-bold text-emerald-800 text-lg">{(item.price * item.quantity).toLocaleString('vi-VN')} đ</p>
