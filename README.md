...
├── context/                     ← 🔍 Codebase context (Repomix)
├── tasks/                       ← Task board
├── src/                         ← Source code
...
│  Update todo.md → extract learnings          │
│  Cuối phase → integration test               │
│  Lặp lại cho phase tiếp                      │
└───────────────────────────────────────────────┘
      ↓
┌─── FINAL PHASE: RELEASE ─────────────────────┐
│  E2E test → monitoring setup → deploy 🚀     │
└───────────────────────────────────────────────┘
```
...
Xem `docs/MONITORING.md` để setup.
